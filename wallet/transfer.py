...
send_wrappedToken = { # txn to be processed by wallet DApp on execution layer (i.e Cartesi node)
    'gas': 25000000,
    'gasPrice': 450000, 
...
signed = w3.eth.account.sign_transaction(send_wrappedToken, PRIVATE_KEY)
msg = str(signed)
